...
function getTargetSelector(element) {
  ...
  while (current && current !== document.body) {
    ...
    const index = Array.from(parent.children).filter((child) => child.tagName === currentTagName).indexOf(current) + 1;
...
function PageFeedbackToolbarCSS({
  ...
  const [layoutRevision, setLayoutRevision] = (0, import_react8.useState)(0);
  ...
  const annotationTargetsRef = (0, import_react8.useRef)(/* @__PURE__ */ new Map());
  const pathname = typeof window !== "undefined" ? window.location.pathname : "/";
  const resolveAnnotationTarget = (0, import_react8.useCallback)((annotation) => {
  ...
  const getLiveAnnotation = (0, import_react8.useCallback)((annotation) => {
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { ref: portalWrapperRef, style: { display: "contents" }, "data-agentation-theme": isDarkMode ? "dark" : "light", "data-agentation-accent": settings.annotationColorId, "data-agentation-root": "", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: styles_module_default4.markersLayer, "data-feedback-toolbar": true, children: [
        markersVisible && visibleAnnotations.map(getLiveAnnotation).filter((a) => !a.isFixed).map((annotation, layerIndex, arr) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
          AnnotationMarker,
          {
            annotation,
          ...
          children: [
            ...
            pendingAnnotation && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
              ...
              (() => {
                ...
                let markerY = pendingAnnotation.isFixed ? pendingAnnotation.y : pendingAnnotation.y - scrollY;
                if (pendingAnnotation.targetElement && document.contains(pendingAnnotation.targetElement)) {
                  const rect = pendingAnnotation.targetElement.getBoundingClientRect();
                  const offset = pendingAnnotation.anchorOffset ?? { x: 0.5, y: 0.5 };
                  markerX = window.innerWidth > 0 ? (rect.left + rect.width * offset.x) / window.innerWidth * 100 : markerX;
              ...
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                AnnotationPopupCSS,
                {
                  ...
                  style: (() => {
                    ...
                    const markerY = liveAnnotation.isFixed ? liveAnnotation.y : liveAnnotation.y - scrollY;
                    return {
                      // Popup is 280px wide, centered with translateX(-50%), so 140px each side
                      // Clamp so popup stays 20px from viewport edges
                      left: Math.max(
