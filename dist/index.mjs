...
function PageFeedbackToolbarCSS({
  ...
  const [layoutRevision, setLayoutRevision] = useState6(0);
  ...
  const annotationTargetsRef = useRef6(/* @__PURE__ */ new Map());
  const pathname = typeof window !== "undefined" ? window.location.pathname : "/";
  const resolveAnnotationTarget = useCallback5((annotation) => {
  ...
  const getLiveAnnotation = useCallback5((annotation) => {
  ...
  return createPortal2(
    /* @__PURE__ */ jsxs13("div", { ref: portalWrapperRef, style: { display: "contents" }, "data-agentation-theme": isDarkMode ? "dark" : "light", "data-agentation-accent": settings.annotationColorId, "data-agentation-root": "", children: [
      ...
      /* @__PURE__ */ jsxs13("div", { className: styles_module_default4.markersLayer, "data-feedback-toolbar": true, children: [
        markersVisible && visibleAnnotations.map(getLiveAnnotation).filter((a) => !a.isFixed).map((annotation, layerIndex, arr) => /* @__PURE__ */ jsx14(
          AnnotationMarker,
          {
            annotation,
